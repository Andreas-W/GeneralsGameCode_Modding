...
//-------------------------------------------------------------------------------------------------
class AdvancedContainModuleData : public TransportContainModuleData
{
public:

	AdvancedContainModuleData();
...
//-------------------------------------------------------------------------------------------------
class AdvancedContain : public TransportContain
{

	MEMORY_POOL_GLUE_WITH_USERLOOKUP_CREATE( AdvancedContain, "AdvancedContain" )
	MAKE_STANDARD_MODULE_MACRO_WITH_MODULE_DATA(AdvancedContain, AdvancedContainModuleData )
...
public:
	...
	AdvancedContain( Thing *thing, const ModuleData* moduleData );
